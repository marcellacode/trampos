...
export const metadata: Metadata = {
  title: "Criar conta — Jobera",
  description: "Crie sua conta Jobera e comece a organizar sua carreira com inteligência artificial.",
};
...
export default function Page() {
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-background px-4 py-10 sm:px-6">
      ...
      <div className="relative z-10 w-full max-w-[460px]"><SignUpCard /></div>
    </main>
  );
}
