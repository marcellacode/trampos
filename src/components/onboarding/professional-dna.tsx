  ...
  return (
    <div className={cn("mx-auto w-full max-w-3xl space-y-8 py-4", className)}>
      ...
      <motion.section
        ...
        className="space-y-6 rounded-2xl border border-border bg-card/85 p-5 backdrop-blur-sm sm:p-7"
