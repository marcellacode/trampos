      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
        {metrics.map((metric, index) => (
          <motion.article
            ...
            whileHover={{ y: -3 }}
            className="group rounded-2xl border border-white/[0.08] bg-[#111315] p-4 transition-shadow hover:border-white/[0.12] hover:shadow-[0_0_40px_rgba(79,124,255,0.08)]"
          >
            ...
            <div className="mt-2 flex items-baseline gap-2">
              ...
              {metric.delta && (
                <span
                  className={cn(
                    "text-xs font-medium",
                    metric.deltaPositive ? "text-[#22C55E]" : "text-[#EF4444]"
                  )}
                >
                  {metric.delta}
                </span>
