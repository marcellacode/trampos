...
function GoogleIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path
        fill="#34A853"
        d="M6.6 14.3l-.7.5-2.4 1.9C5.1 19.3 8.3 21 12 21c2.7 0 5-.9 6.7-2.4l-3.1-2.4c-.8.6-1.9.9-3.6.9-2.8 0-5.1-1.9-6-4.4z"
      />
      <path
        fill="#4A90E2"
        d="M3.5 7.3C2.9 8.5 2.5 9.9 2.5 11.5s.4 3 1 4.2c0 .1 3.1-2.4 3.1-2.4-.2-.5-.3-1.1-.3-1.7 0-.6.1-1.2.3-1.7L3.5 7.3z"
      />
      <path
        fill="#FBBC05"
        d="M12 5.5c1.5 0 2.8.5 3.8 1.5l2.8-2.8C16.9 2.5 14.7 1.5 12 1.5 8.3 1.5 5.1 3.2 3.5 6.3l3.1 2.4c.8-2.5 3.1-4.2 5.4-4.2z"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      {ripples.map((ripple) => (
        <span
          key={ripple.id}
          className="pointer-events-none absolute h-20 w-20 -translate-x-1/2 -translate-y-1/2 animate-ping rounded-full bg-white/10"
          style={{ left: ripple.x, top: ripple.y, animationDuration: "600ms" }}
        />
      ))}
    </motion.button>
  );
...
export function SocialButtons({ disabled, onError }: SocialButtonsProps) {
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2.5" role="group" aria-label="Login social">
